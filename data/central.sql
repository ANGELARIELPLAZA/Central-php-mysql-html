...
-- Volcando estructura para tabla data.rutas
CREATE TABLE IF NOT EXISTS `rutas` (
  `id` int NOT NULL AUTO_INCREMENT,
  `code` int DEFAULT NULL,
  `destino` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
-- Volcando estructura para tabla data.ventas
CREATE TABLE IF NOT EXISTS `ventas` (
  `id` int NOT NULL AUTO_INCREMENT,
  `codigo_ruta` int DEFAULT NULL,
  `nombre_ruta` varchar(50) DEFAULT NULL,
  `vendedora` varchar(50) DEFAULT NULL,
  `cantidad_boletos` int DEFAULT NULL,
  `tipo_boleto` varchar(50) DEFAULT NULL,
  `precio_ruta` varchar(50) DEFAULT NULL,
